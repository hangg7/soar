...
class SMPL_Guidance(BaseObject):
    ...
    class Config(BaseObject.Config):
        ...
        seq: str = "dance"
        dataset: str = "zju-mocap" #"fs-xhumans/soar" #neuman" #"insav_wild"  # "dna_rendering" #"insav_wild"
        ...
        **kwargs,
        ...
        with torch.no_grad():
            if smpl_parms is not None or idx is not None:
                ...
                live_smpl = self.smpl_model.forward(
                    betas=self.smpl_parms_["betas"][None],
                    ...
                    **{
                        ...
                        if k not in ["betas", "body_pose", "global_orient", "transl"]
                    },
                )
