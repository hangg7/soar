...
# This file is modified from https://github.com/YuliangXiu/ICON/blob/master/fetch_data.sh.
...
# Segment Anything
echo -e "\nDownloading Segment Anything model..."
wget 'https://dl.fbaipublicfiles.com/segment_anything/sam_vit_h_4b8939.pth' -O './data/ckpt/sam_vit_h_4b8939.pth' --no-check-certificate --continue
